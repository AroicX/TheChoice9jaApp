                  ...
                  <Menu.Item>
                    <button onClick={() => router.push("/analytics")} className="group flex w-full items-center rounded-md px-2 py-2 text-sm">
                      <Result
                        ...
                        aria-hidden="true"
                      />
                      <span className='text-md text-coolblack-300'>Edit Discourse Post</span>
                    </button>
                  </Menu.Item>
                </div>
                <div className="px-1 py-1 ">
                  <Menu.Item>
                    <button className="group flex w-full items-center rounded-md px-2 py-2 text-sm">
                      <Result
                        ...
                        aria-hidden="true"
                      />
                      <span className='text-md text-coolblack-300'>Delete Post</span>
                    </button>
                  </Menu.Item>
                </div>
                <div className="px-1 py-1 ">
                  <Menu.Item>
                    <button onClick={() => push("/reports")} className="group flex w-full items-center rounded-md px-2 py-2 text-sm">
                      <Report
                        className="mr-2 h-5 w-5"
                        aria-hidden="true"
                      />
