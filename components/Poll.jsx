...
export const ICONS = [
  {
    ...
    count: 10000,
    icon: (props) => (
      <svg fill="none" {...props} stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path 
          strokeLinecap="round" 
  ...
  },
  {
    ...
    count: 0,
    icon: (props) => (
      <svg {...props} viewBox="0 0 18 17" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path 
          fillRule="evenodd" 
          clipRule="evenodd" 
      ...
      >
        {({active, checked}) => (
          <>
            ...
            <div className="-mt-px p-4 font-bold flex items-center space-x-4 divide-x bg-coolblack-50 divide-gray-200">
      ...
      <div className="flex-1">
        ...
        <div className="mt-2 space-y-2">
          <header onClick={() => router.push("/poll")}>
            <h3 className="uppercase text-green-neutral-500">poll</h3>
