    ...
    <AuthProvider>
      ...
      <form className='space-y-8'>
        <h3 className='mt-8 font-bold text-2xl'>
          One last step, Verify that you’re a Nigerian
        </h3>
        <p className='text-slate-500'>
          To verify that you’re a nigerian, we will need any of this approved
        ...
        <Select
          ...
          options={[
            { name: 'NIN or NIMC Card PIN' },
            { name: 'Bank Verification Number (BVN)' },
            { name: "'Voter's Card Number" },
            { name: 'International Password Number' },
          ]}
      ...
      <div className='flex items-end h-full mb-8'>
        <div className='w-full'>
          <Link href='/signup/create_password'>
