      ...
      <Layout>
        ...
        <main className='px-2'>
          ...
          <ul className='mt-6 space-y-4'>
            {candidates.map(
              ({ id, title, description, status, statusColor, slug }) => (
                <li
                  key={id}
                  onClick={() => router.push(`/voting/${slug}`)}
                ...
                >
                  <div className='mb-10 flex w-full items-center justify-between space-x-6 px-6 py-6 pb-2'>
                    ...
                    <div
                      className={`${
                        id > 0 ? 'bg-secondaryColor-200' : 'bg-greenPrimary-100'
                  ...
                  <div
                    className={`bottom-0 font-10 rounded-tr-md rounded-bl-md absolute px-4 py-1 ${statusColor}`}
                  >
                    {status}
                  </div>
                </li>
