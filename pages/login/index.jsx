    ...
    <AuthProvider>
      ...
      <form onSubmit={handleSubmit} className=''>
        ...
        <div className="relative hidden">
          <input type="text" id="floating_outlined" className="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 focus:outline-none focus:ring-0 focus:border-green-primary peer" placeholder=" " />
