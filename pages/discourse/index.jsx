...
export default function Discussion() {
  ...
  return (
    <>
    <header className="flex items-center px-2 py-2 border-b border-coolblack-200 pb-2">
      <Avatar 
        alt="Bash picture" 
        style="w-9 h-9"
    ...
    <Layout>
      <main className="mt-6 border-b-4 pb-6">
        <h4 className="text-black-primary font-16 font-inter--sm mb-3">Discourse Forums</h4>
              ...
              {discussions.discussions.map(({id, topic}) => (
                <li onClick={() => router.push(`discourse/${id}`)} key={id} className="flex items-center pt-3 justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-black-primary font-14 font-inter--sm">{topic}</span>
                  </div>
